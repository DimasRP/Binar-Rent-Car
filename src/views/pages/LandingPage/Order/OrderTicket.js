        ...
        <div className="w-full flex flex-col items-center">
          ...
          <div className="w-full max-w-3xl bg-white p-6 border rounded-md">
            <div className="flex items-start justify-between gap-4 mb-6">
              ...
              <button className="flex items-center gap-2 px-4 py-2 text-dark-blue-04 border-dark-blue-04 hover:bg-dark-blue-00 rounded-sm border-2 font-bold">
            ...
            <div className="w-full h-48 bg-gray-100 mx-auto border-2 border-dashed rounded-md flex justify-center items-center">
              ...
              >
                <Page
                  className={
                    "w-full h-full overflow-y-auto sm:flex sm:justify-center"
                  }
